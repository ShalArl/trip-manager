...
import { Building2, Users, Megaphone, Plus, Trash2, Link } from "lucide-react";
import { listAdvertisers, createAdvertiser, assignTenant, removeTenant, Advertiser } from "@/lib/api/advertiser";
            ...
            <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                ...
                {activeTab === "tenants" && (
                    <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                        <div className="px-6 py-4 border-b border-zinc-100 dark:border-zinc-800">
                            <h2 className="text-sm font-semibold text-zinc-900 dark:text-white">Alle Tenants ({tenants.length})</h2>
                        </div>
                ...
                {activeTab === "advertisers" && (
                    <div className="space-y-6">
                        ...
                        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                            <div className="px-6 py-4 border-b border-zinc-100 dark:border-zinc-800">
                                <h2 className="text-sm font-semibold text-zinc-900 dark:text-white">Advertiser ({advertisers.length})</h2>
                            </div>
                            <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
                                        ...
                                        {(adv.tenants ?? []).length > 0 && (
                                            <div className="flex flex-wrap gap-2">
                                                {adv.tenants.map((tid) => {
                                                    ...
                                                    return (
                                                        <span key={tid} className="flex items-center gap-1.5 text-xs px-2 py-1 bg-zinc-100 dark:bg-zinc-800 rounded-full">
                                                            {tenant?.name ?? tid}
