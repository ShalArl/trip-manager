        ...
        <div ref={containerRef} className="relative">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className={`w-full pl-9 pr-4 py-2 rounded-lg border bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-[var(--brand-primary)] transition-colors ${
                        selected
            ...
            {/* Selected badge */}
            {selected && (
                <p className="mt-1 text-xs text-[var(--brand-primary)] dark:text-[var(--brand-primary-light)]">
