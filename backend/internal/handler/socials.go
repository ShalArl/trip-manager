...
// GetTripLikesHandler handles GET /trips/{tripId}/likes (optional auth)
...
// LikeTripHandler handles POST /trips/{tripId}/likes (auth required)
...
// UnlikeTripHandler handles DELETE /trips/{tripId}/likes (auth required)
...
// ListTripCommentsHandler handles GET /trips/{tripId}/comments (optional auth)
...
// CreateTripCommentHandler handles POST /trips/{tripId}/comments (auth required)
...
// DeleteTripCommentHandler handles DELETE /trips/{tripId}/comments/{commentId} (auth required)
